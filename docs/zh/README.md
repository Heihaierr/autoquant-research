# autoquant-research（中文版）

![一位头发花白的资深投资人用放大镜揭开一份漂亮的回测，发现底下藏着一份崩盘的回测，周围是研究闭环的图标和一座挂满失败案例的博物馆](../assets/hero.jpg)
...
> 英文版是主版本：[../../README.md](../../README.md)。中文版内容与英文版一致。
...
```
  ① framing-the-goal        ← 唯一与你对话的一步
       ▼
  ② building-the-foundation ← 先数据，再引擎，再被动对照
       ▼
  ③ running-experiments     ← 试什么、怎么测、按什么顺序试    ◀─┐
       ▼                                                        │
  ④ judging-the-round       ← 先归因，再 SHIP/ITERATE/STOP      │
       │                                                        │
       ├── ITERATE ──────────────────────────────────────────────┘
       ▼ SHIP
  ⑤ shipping-and-tracking   ← 冻结、留出前向期、持续对账
```
...
<p align="center">
  <img src="../assets/automation-hero.jpg" width="640" alt="定目标只对话一次，剩下的闭环自己跑得更快，跑出来的东西是拿到真实世界里也站得住的。">
</p>
